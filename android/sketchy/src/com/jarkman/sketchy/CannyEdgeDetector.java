...
public class CannyEdgeDetector {
	...
	public CannyEdgeDetector( Sketchy sketchy ) {
		mSketchy = sketchy;
	    ...
	    SharedPreferences prefs=PreferenceManager.getDefaultSharedPreferences(sketchy);
	 	...
	 	gaussianKernelRadius = (Float.valueOf(gaussianKernelRadiusS) * mSketchy.mImageWidth) / Settings.mBaseImageWidth;
	 	gaussianKernelWidth = (Integer.valueOf(gaussianKernelWidthS) * mSketchy.mImageWidth) / Settings.mBaseImageWidth;
	...
	public void process() {
		mSketchy.updateProgress("Canny start");
		width = sourceImage.getWidth();
		height = sourceImage.getHeight();
		picsize = width * height;
		initArrays();
		
		mSketchy.updateProgress("Canny readLuminance");
		...
		mSketchy.updateProgress("Canny normalise");
		...
		mSketchy.updateProgress("Canny compute gradients");
		...
		mSketchy.updateProgress("Canny hysteresis");
		...
		mSketchy.updateProgress("Canny threshold");
		...
		mSketchy.updateProgress("Canny write");

		
		writeEdges(data);
		
		mSketchy.updateProgress("Canny done");
